      ...
      items: [
        ...
        BottomNavigationBarItem(
          activeIcon: Image.asset(
            'assets/images/icons/bottomtab/home.png',
            width: 24,
            height: 24,
        ...
        BottomNavigationBarItem(
          activeIcon: Image.asset(
            'assets/images/icons/bottomtab/dashboard.png',
            width: 24,
            height: 24,
            // color: AppColors.black,
          ),
        ...
        BottomNavigationBarItem(
          activeIcon: Image.asset(
            'assets/images/icons/bottomtab/tools.png',
            width: 24,
            height: 24,
            // color: AppColors.black,
          ),
...
//     return Scaffold(
//       appBar: index == 0 || index == 3 || index == 2 || index == 1 ? null : buildAppBar(context),
//       body: child,
//       bottomNavigationBar: _buildBottomNavigationBar(
//         context,
//         ref.watch(bottomNavIndexProvider), 
