...
class TransactionDetailScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final dateTime = '${transaction.createdAt.formatShortDate()} at ${transaction.createdAt.formatTime()}';
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 8),
                    Text(
                      'This payment brings your rent goal to 85% completion. You\'re ₦4,500 away from your target.',
                      style: const TextStyle(
                        fontSize: 14,
                        height: 1.5,
