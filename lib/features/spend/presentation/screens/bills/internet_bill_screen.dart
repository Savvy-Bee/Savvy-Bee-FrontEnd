      ...
      body: ListView(
        ...
        children: [
          ...
          CustomTextFormField(
            ...
            suffix: Icon(Icons.keyboard_arrow_down),
            readOnly: true,
            onTap: () => PackageBottomSheet.show(context),
          ),
          const Gap(16),
          CustomTextFormField(
            label: 'Customer ID',
...
class PackageBottomSheet extends StatefulWidget {
  const PackageBottomSheet({super.key});

  @override
  State<PackageBottomSheet> createState() => _PackageBottomSheetState();
...
class _PackageBottomSheetState extends State<PackageBottomSheet> {
  @override
  Widget build(BuildContext context) {
    return ListView(
      padding: const EdgeInsets.all(16),
