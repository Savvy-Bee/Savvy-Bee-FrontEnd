...
// ─────────────────────────────────────────────────────────────────────────────
// Debt types accepted by the manual-create endpoint
// ─────────────────────────────────────────────────────────────────────────────

const List<String> _kDebtTypes = [
  'Others',
  'Personal Loan',
  'Credit Card',
  'Mortgage',
...
class _AddDebtScreenState extends ConsumerState<AddDebtScreen> {
  ...
  // ── State ─────────────────────────────────────────────────────────────────
  String _selectedDebtType = _kDebtTypes.first;
  ...
  Future<void> _submit() async {
    ...
    try {
      final request = ManualDebtRequestModel(
        name: _nameController.text.trim(),
        owed: num.parse(_owedController.text.replaceAll(',', '')),
        minPayment: num.parse(_minPaymentController.text.replaceAll(',', '')),
        ...
        child: ListView(
          ...
          children: [
            ...
            CustomDropdownButton(
              ...
              onChanged: (val) {
                if (val != null) setState(() => _selectedDebtType = val);
              },
            ),
            const Gap(16),
