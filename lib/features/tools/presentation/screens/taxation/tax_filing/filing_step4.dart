...
// /// Numeric filing fee keyed by plan title (matches _plans in Step 2).
// const _planFees = <String, double>{
//   'Basic PAYE': 7500,
//   'Freelancer': 25000,
//   'SME Lite': 75000,
//   'Pro / Complex': 0, // custom quote — show 0 until confirmed
// };
...
//     // Filing fee driven by selected plan
//     final filingFee = _planFees[selectedPlan] ?? 0.0;
//     final isCustomQuote = selectedPlan == 'Pro / Complex';

//     // Wallet balance from filing API
//     final walletBalance = filingData?.taxPot ?? 0.0;
//     final walletSufficient = walletBalance >= filingFee;
...
//           borderRadius: BorderRadius.circular(12),
//           color:
//               isSelected ? _yellow.withValues(alpha: 0.05) : Colors.white,
//         ),
//         child: Row(
//           children: [
//             Icon(icon, size: 20, color: Colors.black87),
