...
//
// Screen 1 / 5 — Taxpayer Classification
// Shared entry for both Personal and Business registration paths.
...
class _TinRegScreen1State extends State<TinRegScreen1> {
  // null = nothing selected | true = Individual | false = Corporate
  bool? _isIndividual;
  ...
  void _onContinue() {
    if (_isIndividual == null) return;
    if (_isIndividual!) {
      context.pushNamed(FilingRoutes.tinRegPersonal2);
    } else {
      context.pushNamed(FilingRoutes.tinRegBusiness2);
    }
  }
      ...
      appBar: AppBar(
        ...
        actions: [
          Padding(
            ...
            child: Center(
              child: Text('1/5', style: _gs(13, color: AppColors.greyDark)),
            ),
          ),
        ],
        elevation: 0,
        ...
        bottom: const _ProgressBar(step: 1, total: 5),
      ),
      body: SafeArea(
        child: Column(
          children: [
            Expanded(
              child: ListView(
                ...
                children: [
                  const _StepBadge(
                    label: 'STEP 1 OF 5 · TAXPAYER CLASSIFICATION',
                  ),
                  const Gap(20),
                  Text(
                    'Who is registering?',
                  ...
                  const Gap(6),
                  Text(
                    'Select your taxpayer classification to get started.',
                  ...
                  _ClassificationTile(
                    ...
                    title: 'Individual',
                    subtitle:
                        'Personal income — salary, freelance, investments',
                    isSelected: _isIndividual == true,
                  ...
                  _ClassificationTile(
                    ...
                    subtitle: 'Registered company, SME or partnership',
                    isSelected: _isIndividual == false,
                          ...
                          child: RichText(
                            text: TextSpan(
                              ...
                              children: const [
                                ...
                                TextSpan(
                                  text: ' file a Personal Income Tax return. ',
                                ),
                                TextSpan(
                                  text: 'Corporates',
                                  style: TextStyle(fontWeight: FontWeight.w700),
                                ...
                                TextSpan(
                                  text:
                                      ' file Company Income Tax (CIT) and may also have personal director returns.',
                                ),
                              ],
                            ),
                          ),
          ...
          children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                border: Border.all(
                  color: isSelected ? _yellow : const Color(0xFFCCCCCC),
                  width: 2,
                ),
...
// ─────────────────────────────────────────────────────────────────────────────
// Shared widgets used across all TIN reg screens
// ─────────────────────────────────────────────────────────────────────────────
