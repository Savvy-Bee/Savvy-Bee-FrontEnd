...
class _ProfileScreenState extends ConsumerState<ProfileScreen> {
  ...
  void initState() {
    ...
    if (widget.verificationStatus != null && widget.verificationStatus != '') {
      ...
      // _verificationMessage = _getVerificationMessage(
...
//   // Updated complete profile card widget
//   // Replace your existing _buildCompleteProfileCard method with this

//   Widget _buildCompleteProfileCard(BuildContext context, HomeData data) {
//     // Calculate completion status
//     final hasAvatar = data.profilePhoto.isNotEmpty;
//     final hasBiometric = false; // Not yet implemented
//     final hasPIN = false; // Not yet implemented
...
//     // Build list of incomplete items only
//     final List<Map<String, dynamic>> incompleteItems = [];
...
//         'subtitle': 'Start a new goal',
//         'onTap': () {
//           // Navigate to biometric setup when implemented
//           // context.pushNamed(BiometricSetupScreen.path);
//           ScaffoldMessenger.of(context).showSnackBar(
//             const SnackBar(content: Text('Biometric setup coming soon')),
//           );
//         },
...
//         'subtitle': 'A smarter way to track existing debt',
//         'onTap': () {
//           // Navigate to PIN setup when implemented
//           // context.pushNamed(PINSetupScreen.path);
//           ScaffoldMessenger.of(context).showSnackBar(
//             const SnackBar(content: Text('PIN setup coming soon')),
//           );
//         },
...
//               crossAxisAlignment: CrossAxisAlignment.start,
//               children: [
//                 // Dynamic list of incomplete items
//                 ...incompleteItems.asMap().entries.map((entry) {
//                   final index = entry.key;
//                   final item = entry.value;
//                   final isLast = index == incompleteItems.length - 1;
...
//   // Update the hasUnfinishedProfile logic to include avatar, biometric, and PIN
//   bool _hasUnfinishedProfile(HomeData data) {
//     final hasAvatar = data.profilePhoto.isNotEmpty;
//     final hasBiometric = false; // Not yet implemented
//     final hasPIN = false; // Not yet implemented

//     // Show card if any of these are incomplete
//     return !hasAvatar || !hasBiometric || !hasPIN;
//   }

//   // And update the card call to pass data:
//   // _buildCompleteProfileCard(context, data)
